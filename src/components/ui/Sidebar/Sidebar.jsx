      ...
      <div className="sm:w-[350px] w-[80px] sm:min-w-[300px] mt-3 sm:h-[95%] h-[70%] py-[30px] bg-light-gray dark:bg-dark-gray-3 transition-all duration-300 ease-in-out  shadow-sm rounded-r-lg ">
        <div className="flex flex-col items-center gap-4">
          <div>
            ...
            {onEditAvatar && (
              <button className="mx-auto bg-white p-[2px] rounded text-center border border-primary-green gap-1 flex sm:translate-y-[-20px] sm:translate-x-[-20px] translate-x-[-10px] translate-y-[-20px]">
