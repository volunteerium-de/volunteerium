...
//                 <label className="block text-[1rem] text-gray-2" htmlFor="name" name="name">
//                   Organization Name
//                 </label>
//                 <input
//                   id="name"
...
//               </div>
//               <div className="flex-1 flex flex-col">
//                 <label className="block text-[1rem] text-gray-2" htmlFor="url" name="url">
//                   Organization URL
//                 </label>
//                 <input
//                   id="url"
...
//                 <div
//                   key={certificate.id}
//                   className={`bg-light-gray mb-[${index === certificates.length ? 25 : 15}px] w-full`}
//                 >
