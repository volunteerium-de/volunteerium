    ...
    <div className="h-auto">
      <main className="font-['Poppins']">
        ...
        <section>
          <div>
            <div
              className="bg-center bg-cover max-w-[1440px] min-h-[368px] block mx-auto"
              style={{ backgroundImage: `url(${backgroundImage})` }}
            >
              {/* About Us Area */}
              <div className="min-h-[368px] border mx-auto backdrop-blur">
                <h1 className="text-[2.25rem] leading-[0.75] text-white text-center mt-[88px]">
                  About Us
                </h1>
            ...
            <div className="h-auto max-w-[1440px] mx-auto rounded-lg mt-[50px] flex flex-col sm:flex-row items-center justify-center gap-5">
              ...
              <div className="max-w-[463px] w-full h-auto bg-dark-green text-center  text-white rounded-lg mb-[16px] p-5 md:transform md:translate-x-[100px] sm:transform sm:translate-x-0">
                ...
                <p className="text-[1rem] font-medium mb-10">
                  ...
                  Volunteerium is here to help. We are a team of passionate professionals committed
                  to fostering a culture of giving and community support.
                </p>
              </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-5">
              ...
              <div className="max-w-[408px] w-full h-[241px] bg-white rounded-lg p-[30px]  text-center ">
                ...
                <p className="text-[1rem] leading-[1.6875] text-gray-2 mt-4">
                  Browse through a wide range of volunteer opportunities tailored to your interests
                  and location.
                </p>
              </div>
              ...
              <div className="max-w-[408px] w-full h-[241px] bg-white rounded-lg p-[30px]  text-center ">
                ...
                <p className="text-[1rem] leading-[1.6875] text-gray-2 mt-4">
                  Once you find an event that interests you, join to volunteer. The event organizer
                  will review your application and confirm your participation.
                </p>
              </div>
