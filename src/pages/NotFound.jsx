...
const NotFound = () => {
  return (
    <div className="w-full min-h-screen dark:bg-black flex flex-col items-center justify-start ">
      {/* Header Placeholder */}
      ...
      >
        <Link
          to="/"
          className="bg-primary-green text-white w-72 rounded-lg  hover:bg-dark-green transition duration-300 flex items-center justify-center "
        >
          Back to Homepage
        </Link>
      </div>
