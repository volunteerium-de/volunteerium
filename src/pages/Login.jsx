  ...
  return (
    <div>
      ...
      <div className="flex flex-col max-w-full w-[1440px] mx-auto font-poppins dark:bg-black">
        {/* Main Div */}
        <div className="flex flex-col md:flex-row pt-5 max-w-[1440px] justify-center items-center h-full">
          {/* Left side */}
          ...
          {/* Right Side */}
          <div className="flex-grow flex flex-col justify-center my-auto w-full p-4 md:px-8">
            {/* ArrowBack Icon and Logo for Mobile Design */}
            <div className="md:hidden flex flex-col items-center mb-6">
              <IoIosArrowBack className=" text-3xl cursor-pointer self-start" />
              <img src={logo} alt="Logo" className="h-16 w-auto" />
            </div>

            <div className="flex-grow">
              <h1 className=" dark:text-white text-[1.75rem] text-center md:text-center md:text-[2rem] font-semibold mb-6">
                Sign In
              </h1>
