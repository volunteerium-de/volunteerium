    ...
    <div className="h-full w-full flex flex-col justify-center px-5 md:px-0 bg-primary-green bg-opacity-60">
      ...
      <div className="relative text-left ps-6 lg:px-8">
        ...
        <p className="text-white mt-4 text-[1rem] lg:text-[1.125rem] font-normal">
          ...
          Login to continue making <b> a difference</b>.<br /><br />
          </span>
        ...
        {/* Right Side */}
        <div className="flex-grow flex flex-col justify-center my-auto p-4 md:p-8 w-full">
          ...
          <div className="flex-grow">
            <h1 className="text-black dark:text-white text-[1.75rem] text-center md:text-center md:text-[2rem] font-semibold mb-6">Sign In</h1>
