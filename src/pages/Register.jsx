...
const Register = () => {
  ...
  return (
    <div>
<Header/>
<div className="flex flex-col max-w-[1440px] mx-auto font-poppins h-auto dark:bg-black">

      {/* Main Div */}
      <div className="flex flex-col md:flex-row pt-5 max-w-[1440px] justify-center min-h-[800px]">

        {/* Left side */}
        <div className="hidden md:block max-w-full md:max-w-[608px] mx-2 md:mx-4 lg:mx-8 w-full bg-primary-green overflow-hidden rounded-lg xl:h-90% ">
  <div 
  ...
  >
    <div className="h-full w-full flex flex-col justify-center px-5 md:px-0 bg-primary-green bg-opacity-60">
      ...
      <div className="relative text-left ps-6 lg:px-8">
        ...
        {/* Right Side */}
        <div className="flex-grow flex flex-col justify-start p-4 md:px-8 w-full h-full ">
          ...
          <div className="flex-grow">
            <h1 className="text-black dark:text-white text-[1.75rem] text-center md:text-left md:text-[2rem] font-semibold mb-4">Create Your Account</h1>
